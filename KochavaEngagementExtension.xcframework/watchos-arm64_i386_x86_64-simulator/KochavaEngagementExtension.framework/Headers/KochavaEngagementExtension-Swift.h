...
/// Call this method to modify the UNNotificationContent object that was delivered with the notification.  At some point during your implementation and following the call to the closure_didComplete, execute the contentHandler closure and pass it the modified content.
...
/// This method has a limited amount of time (no more than 30 seconds) to modify the content and execute the closure_didComplete closure.  If it does not execute that closure in a timely manner, the system calls your extension’s serviceExtensionTimeWillExpire() method to give you one last chance to execute the contentHandler closure.  If you do not, the system presents the notification’s original content to the user.
...
///
/// \param closure_didComplete The closure to execute when completed with any asynchronously gathered content.  This closure has no return value and passes the following parameter: asynchronousNotificationAttachmentArray: An array of UNNotificationAttachment(s) which were gathered asynchronously to be appended to the notification content.
///
- (void)kva_didReceiveNotificationRequest:(UNNotificationRequest * _Nonnull)request content:(UNMutableNotificationContent * _Nonnull)content tokenReplacementDictionary:(NSDictionary * _Nullable)tokenReplacementDictionary closure_didComplete:(void (^ _Nonnull)(NSArray<UNNotificationAttachment *> * _Nullable))closure_didComplete;
- (void)kva_didReceiveNotificationRequest:(UNNotificationRequest * _Nonnull)request withContent:(UNMutableNotificationContent * _Nonnull)content tokenReplacementDictionary:(NSDictionary * _Nullable)tokenReplacementDictionary completionHandler:(void (^ _Nonnull)(NSArray<UNNotificationAttachment *> * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("Modern Objective-C-termed initializer deprecated.  Use Swift func kva_didReceive(notificationRequest:content:tokenReplacementDictionary:closure_didComplete:) instead.  If in Objective-C then use -kva_didReceiveNotificationRequest:content:tokenReplacementDictionary:closure_didComplete:", "kva_didReceiveNotificationRequest:content:tokenReplacementDictionary:closure_didComplete:");
@end
