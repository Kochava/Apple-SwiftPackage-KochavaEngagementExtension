...
/*!
 ...
 @discussion Call this method to modify the UNNotificationContent object that was delivered with the notification.  At some point during your implementation and following the call to the completionHandler, execute the contentHandler block and pass it the modified content.
 ...
 This method has a limited amount of time (no more than 30 seconds) to modify the content and execute the completionHandler block.  If it does not execute that block in a timely manner, the system calls your extension’s serviceExtensionTimeWillExpire() method to give you one last chance to execute the contentHandler block.  If you do not, the system presents the notification’s original content to the user.
 ...
 @param completionHandler The block to execute when completed with any asynchronously gathered content.  This block has no return value and passes the following parameter:
